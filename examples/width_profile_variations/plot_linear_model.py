#!/usr/bin/env python3
"""
Linear model comparison plot for width profile variations.
...
def plot(output_dir):
    ...
    subplot_mosaic = [
        ...
        ["thickness_final","thickness_final", "terminus_mb",       "terminus_mb",       "flux_pct_change",   "flux_pct_change",   "plan_top_heavy", "plan_top_heavy"],
        ["scatter_dL",     "scatter_dL",      "scatter_tau",       "scatter_tau",       "plan_neutral",      "plan_neutral",      "plan_bottom_heavy","plan_bottom_heavy"],
    ...
    fig.suptitle("Width Profile Variations: Linear Model Comparison", fontsize=16)
    ...
    # --- Plan views ---
    plan_axes_map = {"top_heavy": "plan_top_heavy", "neutral": "plan_neutral", "bottom_heavy": "plan_bottom_heavy"}
    if "h" in ds.data_vars:
        for profile_type in ordered_profiles:
    ...
    if profiles_with_data:
        ...
        for p in profiles_with_data:
            ...
            # show where the required beta would put the point (on the 1:1 line)
    ...
    plot_path = output_dir / "width_profile_linear_model.png"
