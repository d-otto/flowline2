#!/usr/bin/env python3
"""
Visualization for the width shape variations example.

Reads output files from the sweep and produces the analysis plot.
Can be run standalone: uv run examples/width_shape_variations/plot.py [output_dir]
"""
...
def plot(output_dir):
    ...
    print("Creating width shape analysis...")
    ...
    fig.suptitle("Width Shape Effects on Glacier Dynamics: Hourglass vs Oval", fontsize=16)
    ...
    axes["width_profiles"].set_title("Width Shape Comparison")
    ...
    # 18. Beta = total area / (width * thickness), three calculation approaches
